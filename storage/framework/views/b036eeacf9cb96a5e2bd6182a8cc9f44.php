...
<div class="container">
	<div class="row">
		<div class="col-12">
        <h1 class="display-3 mt-5">Register a new user</h1>
			<form id="add-frm" method="POST" action="<?php echo e(route('user.store')); ?>" class="border p-3 mt-2">
				...
				<div class="control-group col-6 text-left mt-2"><button class="btn btn-primary">Add New User</button></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Robert\Software Development\laravel\Schnuppertag\resources\views/users/register.blade.php ENDPATH**/ ?>